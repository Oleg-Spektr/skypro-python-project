...
def invalid_dates_transactions() -> list[dict[str, Any]]:
    ...
    return [{"id": 100, "state": "EXECUTED", "date": "not-a-date"}, {"id": 200, "state": "EXECUTED", "date": ""}]
...
def test_sort_by_date_order(
    sample_transactions: list[dict[str, Any]], descending_param: bool, expected_ids: list[int]
) -> None:
